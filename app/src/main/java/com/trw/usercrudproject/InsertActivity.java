    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Call<PostPutDelUser> postlUserCall = mApiInterface.postUser(editName.getText().toString(),editEmail.getText().toString());
                postlUserCall.enqueue(new Callback<PostPutDelUser>() {
                    @Override
